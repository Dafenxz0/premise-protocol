...
| `FULL_RESOURCE_ONLY` | fallback | Declara que el adapter solo puede invalidar por recurso completo. | `resource-wide-only` | No se afirma precisión por scope. | Invalidación amplia y explícita. |
