 ...
 */
export function createBearerAuthorizer({ environment, token, tenantId }) {
  ...
  if (production && (configuredToken === undefined || configuredToken.length < 32)) {
    throw new Error("PREMISE_API_TOKEN must be a high-entropy token of at least 32 characters in production");
  }
