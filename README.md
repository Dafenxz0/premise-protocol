...
- En el workload de corpus, retrieval y dependencias, mantiene **100%** de precisión, seguridad, reparación de todos los afectados y hit-rate hasta **100.000 nodos**, con tres patrones de grafo y documentos reales en disco cuyo payload no entra en los envelopes. En la última ejecución, el camino de protocolo/query quedó en aproximadamente **2,76–3,38 s** por patrón y la generación del corpus de 100.000 documentos tardó **124,1 s** en esta máquina.
